...
pub fn get_all_templates() -> Vec<OntologyTemplateCategory> {
    vec![
        ...
        OntologyTemplateCategory {
            ...
            description: "System registration, configuration changes, and structural properties".into(),
            schema_desc: "Tracks configurations, environment metadata, technology stacks, owners, and URLs".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            description: "Interactive logins, dashboard activities, administrative actions, and updates".into(),
        ...
        OntologyTemplateCategory {
            ...
            description: "Anomaly calculations, abnormal login times, and transaction spikes".into(),
        ...
        OntologyTemplateCategory {
            ...
            description: "Step-by-step histories of critical operations (e.g. server deletion)".into(),
            schema_desc: "Links actions with user request parameters, approvals, changes, and reasons".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            description: "Git changes, continuous integration builds, and deployment statuses".into(),
        ...
        OntologyTemplateCategory {
            ...
            description: "Spikes in CPU/Memory usage, disk full notifications, and SSL outages".into(),
        ...
        OntologyTemplateCategory {
            ...
            schema_desc: "Tracks execution status, retrieved information, and model decisions".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            description: "Initial alert acknowledgements, triage routing, and basic operations".into(),
        ...
        OntologyTemplateCategory {
            ...
            schema_desc: "Identifies permanent resolution adjustments and architecture reviews".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            description: "Investigating errors, tracking trends, and developing permanent fixes".into(),
        ...
        OntologyTemplateCategory {
            ...
            schema_desc: "Tracks approval authority, CAB audits, change types, and window bounds".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            description: "Release rollouts, feature flags adjustments, and validation checks".into(),
        ...
        OntologyTemplateCategory {
            ...
            description: "Requests for Proposal (RFPs), evaluations, compliance checks, and contracts".into(),
            schema_desc: "Stores RFP requirements, cost analysis tables, scoring values, and signs".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            schema_desc: "Tracks domains, days to expiration (30/15/7), CSR logs, and verification state".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            description: "IAM roles, requests, approvals, dormancy audits, and token revocations".into(),
        ...
        OntologyTemplateCategory {
            ...
            description: "Audits (ISO/SOC/PCI/HIPAA), evidence collections, and risk acceptances".into(),
            schema_desc: "Registers target frameworks, policy definitions, and exception approvals".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            description: "Downtimes (planned/emergency), REST outages, restoral steps, and SLA logs".into(),
            schema_desc: "Tracks business impacts, customers notified, downtime minutes, and breaches".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            description: "Auditing dispatch channels (Slack, Teams, PagerDuty, SMS, webhooks)".into(),
        ...
        OntologyTemplateCategory {
            ...
            description: "Agent holds, freeze windows, compliance controls, and manual resumptions".into(),
            schema_desc: "Tracks execution constraints, freeze window limits, and manual overrides".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            description: "Creating SOP articles, updates, reviews, and AI feedback learnings".into(),
            schema_desc: "Registers content edits, confidence adjustments, and feedback scores".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            schema_desc: "Tracks AI recommendations, human choices, cost values, and risk analysis".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            schema_desc: "Tracks security findings, vulnerability records, and malware checks".into(),
            example_events: vec![
                UnifiedEventTemplate {
        ...
        OntologyTemplateCategory {
            ...
            schema_desc: "Logs optimization recommendations, license budgets, and chargebacks".into(),
            example_events: vec![
                UnifiedEventTemplate {
