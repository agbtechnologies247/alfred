...
pub fn api_router(state: AppState) -> Router<AppState> {
    let protected_routes = Router::new()
        ...
        .route("/monitoring/telemetry", get(monitoring::get_monitoring_telemetry))
        .route("/monitoring/errors", get(monitoring::get_monitoring_errors))
        .route("/incidents", get(incidents::get_incidents).post(incidents::create_incident))
        ...
        .route("/sops", get(knowledge::get_sops).post(knowledge::create_sop))
        ...
        .route("/marketplace/packages/agents", get(marketplace::get_agent_packages))
        .route("/marketplace/packages/automations", get(marketplace::get_automation_packages))
        .route("/marketplace/packages/connectors", get(marketplace::get_connector_packages))
        .route("/marketplace/packages/:id/install", post(marketplace::install_package))
        .route("/marketplace/packages/:id/uninstall", post(marketplace::uninstall_package))
        ...
        .route("/decisions/copilot/active", get(decisions::get_copilot_active))
        ...
        .route("/ontology/simulate", post(ontology::simulate_ontology_event))
        
        // === Developer Webhooks API ===
        .route("/developer/webhooks", get(developer::get_developer_webhooks))
        .route("/developer/webhooks", post(developer::create_developer_webhook))
        .route("/developer/webhooks/:id", delete(developer::delete_developer_webhook))
        .route("/developer/keys", get(developer::get_api_keys).post(developer::create_api_key))
        .route("/developer/keys/:id/delete", post(developer::delete_api_key))
