...
impl OpenAiClient {
    ...
    pub async fn generate_rca_tags(
        &self,
        incident_description: &str,
    ) -> Result<RcaResult, Box<dyn std::error::Error + Send + Sync>> {
...
impl VoiceAiClient {
    ...
    pub async fn transcribe_audio(
        ...
        tracing::info!(
            "Mock STT: Transcribing audio using {} with {} threshold",
            self.stt_model,
    ...
    pub async fn generate_speech(
        ...
        tracing::info!(
            "Mock TTS: Generating speech for '{}' using {}",
            text,
            self.tts_model
        );
