...
impl RegistryService {
    pub fn new(pg_pool: Option<sqlx::PgPool>) -> Self {
        ...
        let builtins = vec![
            ...
            // Newly added AI Agents
            PackageManifest {
                id: "agent-kubernetes".into(), name: "Kubernetes SRE Agent".into(), version: "1.2.0".into(),
                publisher: "A.L.F.R.E.D. Official".into(), kind: ManifestKind::AiAgent,
                description: "Autonomous Kubernetes troubleshooter. Auto-resolves CrashLoopBackOff, OOMKilled, and pending pod states.".into(),
                icon: "cpu".into(),
                required_permissions: vec!["cloud.read".into(), "cloud.write".into(), "incidents.write".into()],
                required_connectors: vec!["k8s".into(), "prometheus".into()],
                supported_models: vec!["gpt-4o".into(), "claude-3.5-sonnet".into()],
                pricing: "professional".into(), tags: vec!["k8s".into(), "containers".into(), "remediation".into()],
                install_state: InstallState::Available, rating: 4.9, downloads: 11200,
            },
            PackageManifest {
                id: "agent-database".into(), name: "DBA Optimizer Agent".into(), version: "1.1.0".into(),
                publisher: "A.L.F.R.E.D. Official".into(), kind: ManifestKind::AiAgent,
                description: "Analyzes table locks, query execution plans, vacuum thresholds, and scales connection pools safely.".into(),
                icon: "database".into(),
                required_permissions: vec!["database.read".into(), "database.write".into(), "incidents.write".into()],
                required_connectors: vec!["postgres".into(), "datadog".into()],
                supported_models: vec!["gpt-4o".into()],
                pricing: "enterprise".into(), tags: vec!["database".into(), "postgres".into(), "optimization".into()],
                install_state: InstallState::Available, rating: 4.85, downloads: 7300,
            },
            PackageManifest {
                id: "agent-chaos".into(), name: "Chaos Engineering Agent".into(), version: "1.0.1".into(),
                publisher: "A.L.F.R.E.D. Official".into(), kind: ManifestKind::AiAgent,
                description: "Runs autonomous game days and injection tests (cpu stress, packet delays) to verify self-healing rules.".into(),
                icon: "activity".into(),
                required_permissions: vec!["simulation.write".into(), "cloud.write".into()],
                required_connectors: vec!["aws".into(), "k8s".into()],
                supported_models: vec!["gpt-4o".into(), "llama3-local".into()],
                pricing: "enterprise".into(), tags: vec!["chaos".into(), "testing".into(), "resilience".into()],
                install_state: InstallState::Available, rating: 4.9, downloads: 4900,
            },
            // Newly added Automations
            PackageManifest {
                id: "auto-scale-replicas".into(), name: "Scale K8s Deployment".into(), version: "1.4.0".into(),
                publisher: "A.L.F.R.E.D. Official".into(), kind: ManifestKind::AutomationPack,
                description: "Scales deployment replica levels dynamically based on queue lag and latency alerts.".into(),
                icon: "trending-up".into(),
                required_permissions: vec!["cloud.write".into()],
                required_connectors: vec!["k8s".into()],
                supported_models: vec![],
                pricing: "included".into(), tags: vec!["k8s".into(), "autoscale".into()],
                install_state: InstallState::Available, rating: 4.8, downloads: 15000,
            },
            PackageManifest {
                id: "auto-flush-redis".into(), name: "Flush Redis Buffers".into(), version: "1.0.5".into(),
                publisher: "A.L.F.R.E.D. Official".into(), kind: ManifestKind::AutomationPack,
                description: "Flushes volatile Redis keys under high memory saturation alerts before OOM occurs.".into(),
                icon: "refresh-cw".into(),
                required_permissions: vec!["cache.write".into()],
                required_connectors: vec!["redis".into()],
                supported_models: vec![],
                pricing: "included".into(), tags: vec!["redis".into(), "cache".into()],
                install_state: InstallState::Available, rating: 4.7, downloads: 12200,
            },
            PackageManifest {
                id: "auto-renew-ssl".into(), name: "Renew Let's Encrypt SSL".into(), version: "2.0.0".into(),
                publisher: "A.L.F.R.E.D. Official".into(), kind: ManifestKind::AutomationPack,
                description: "Automates ACME certificate challenges and triggers secure reload of Nginx gateways.".into(),
                icon: "lock".into(),
                required_permissions: vec!["gateway.write".into()],
                required_connectors: vec!["nginx".into()],
                supported_models: vec![],
                pricing: "included".into(), tags: vec!["security".into(), "ssl".into(), "nginx".into()],
                install_state: InstallState::Available, rating: 4.95, downloads: 31000,
            },
        ];
